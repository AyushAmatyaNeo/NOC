...
class Leave extends HrisController {
    ...
    public function indexAction() {
        ...
        $currentMonth = Helper::extractDbData(EntityHelper::rawQueryResult($this->adapter, "SELECT IFNULL(MAX(LEAVE_YEAR_MONTH_NO),0) AS MONTH_NO FROM HRIS_LEAVE_MONTH_CODE WHERE CURRENT_DATE BETWEEN FROM_DATE AND TO_DATE"));
