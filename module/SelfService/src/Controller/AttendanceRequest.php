    ...
    public function addAction() {
        ...
        if ($request->isPost()) {
            ...
            if ($this->form->isValid()) {
                ...
                $attendanceDt = $model->attendanceDt;
                ...
                $model->inTime = Helper::getExpressionDateTimeHana($model->inTime, $attendanceDt);
                $model->outTime = Helper::getExpressionDateTimeHana($model->outTime, $attendanceDt);
                $model->status = "RQ";
