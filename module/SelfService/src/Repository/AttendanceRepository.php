...
class AttendanceRepository extends HrisRepository implements RepositoryInterface {
...
$boundedParameter['toDate'] = $toDate;
        ...
        if ($fromDate != null) {
            $fromDateCondition = " AND A.ATTENDANCE_DT>=TO_DATE(?,'DD-MON-YYYY') ";
        }
        if ($toDate != null) {
            $toDateCondition = " AND A.ATTENDANCE_DT<=TO_DATE(?,'DD-MON-YYYY') ";
        }
        ...
        $sql = "
                SELECT A.ID                                        AS ID,
                  ...
                  BS_DATE((A.ATTENDANCE_DT)) AS ATTENDANCE_DT_BS,
