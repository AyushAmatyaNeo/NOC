...
class TravelRequestForm{
     ...
     * @Annotation\Attributes({ "id":"form-transportTypeList","class":"form-control"})
     */
     ...
     * @Annotation\Required(false)
     * @Annotation\Filter({"name":"StripTags","name":"StringTrim"})
     * @Annotation\Options({"label":"JV Number"})
     * @Annotation\Attributes({"id":"form-jvNumber","class":"form-jvNumber form-control","style":"    height: 50px; font-size:12px"})
     */
    public $jvNumber;
     ...
     * @Annotation\Required(false)
     * @Annotation\Filter({"name":"StripTags","name":"StringTrim"})
     * @Annotation\Options({"label":"Cheque Number"})
     * @Annotation\Attributes({"id":"form-chequeNumber","class":"form-chequeNumber form-control","style":"    height: 50px; font-size:12px"})
     */
    public $chequeNumber;
     ...
     * @Annotation\Required(false)
     * @Annotation\Filter({"name":"StripTags","name":"StringTrim"})
     * @Annotation\Options({"disable_inarray_validator":"true","label":"Bank"})
     * @Annotation\Attributes({ "id":"form-bank","class":"form-control"})
     */
    public $bank;
