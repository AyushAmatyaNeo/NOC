...
class TravelRequest extends Model{
    ...
    const TRANSPORT_TYPE_LIST = "TRANSPORT_TYPE_LIST";
    const RECOMMENDER_ID = "RECOMMENDER_ID";
    const APPROVER_ID = "APPROVER_ID";
    const IS_TEAM_LEAD = "IS_TEAM_LEAD";
    const EXPENSE_AMOUNT = "EXPENSE_AMOUNT";
    ...
    public $mappings= [
        ...
        'recommenderId' => self::RECOMMENDER_ID,
        'approverId' => self::APPROVER_ID,
        'isTeamLead' => self::IS_TEAM_LEAD,
