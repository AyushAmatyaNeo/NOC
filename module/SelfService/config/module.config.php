...
use SelfService\Controller\OutgoingDoc;
...
use SelfService\Controller\TransferSettlement;
use SelfService\Controller\WorkOnDayoff;
use SelfService\Controller\WorkOnHoliday;
use SelfService\Controller\RoleTransfer;
use SelfService\Controller\IncomingDoc;
use SelfService\Controller\TrainingFeedback;
...
return [
    'router' => [
        'routes' => [
            ...
            'trainingFeedback' => [
                'type' => Segment::class,
                'options' => [
                    'route' => '/selfservice/trainingFeedback[/:action[/:employeeId][/:trainingId]]',
                    'constants' => [
                        'action' => '[a-zA-Z][a-zA-Z0-9_-]*',
                        'id' => '[0-9]+',
                    ],
                    'defaults' => [
                        'controller' => TrainingFeedback::class,
                        'action' => 'index',
                    ]
                ],
            ],
            ...
            'overtimeClaim' => [
                'type' => Segment::class,
                'options' => [
                    'route' => '/selfservice/overtimeClaim[/:action[/:id]]',
                    'constants' => [
                        'action' => '[a-zA-Z][a-zA-Z0-9_-]*',
                        'id' => '[0-9]+',
                    ],
                    'defaults' => [
                        'controller' => OvertimeClaim::class,
                        'action' => 'index',
                    ]
                ],
            ],
            ...
            'outgoingdoc' => [
                'type' => Segment::class,
                'options' => [
                    'route' => '/selfservice/outgoingdoc[/:action[/:id]]',
                    'constants' => [
                        'action' => '[a-zA-Z][a-zA-Z0-9_-]*',
                        'id' => '[0-9]+',
                    ],
                    'defaults' => [
                        'controller' => OutgoingDoc::class,
                        'action' => 'index',
                    ]
                ],
            ],
            'incomingdoc' => [
                'type' => Segment::class,
                'options' => [
                    'route' => '/selfservice/incomingdoc[/:action[/:id]]',
                    'constants' => [
                        'action' => '[a-zA-Z][a-zA-Z0-9_-]*',
                        'id' => '[0-9]+',
                    ],
                    'defaults' => [
                        'controller' => IncomingDoc::class,
                        'action' => 'index',
                    ]
                ],
            ],
            'LeaveEncashment' => [
                'type' => Segment::class,
                'options' => [
                    'route' => '/selfservice/LeaveEncashment[/:action[/:id]]',
                    'constants' => [
                        'action' => '[a-zA-Z][a-zA-Z0-9_-]*',
                        'id' => '[0-9]+',
                    ],
                    'defaults' => [
                        'controller' => LeaveEncashment::class,
                        'action' => 'index',
                    ]
                ],
            ],
            'transferSettlement' => [
                'type' => Segment::class,
                'options' => [
                    'route' => '/selfservice/transferSettlement[/:action[/:id][/:role]]',
                    'constants' => [
                        'action' => '[a-zA-Z][a-zA-Z0-9_-]*',
                        'id' => '[0-9]+',
                    ],
                    'defaults' => [
                        'controller' => TransferSettlement::class,
                        'action' => 'index',
                    ]
                ],
            ],
            'vacancies' => [
                'type' => Segment::class,
                'options' => [
                    'route' => '/selfservice/vacancies[/:action[/:id][/:role]]',
                    'constants' => [
                        'action' => '[a-zA-Z][a-zA-Z0-9_-]*',
                        'id' => '[0-9]+',
                    ],
    ...
    'controllers' => [
        'factories' => [
			...
			IncomingDoc::class => ControllerFactory::class,
            RoleTransfer::class => ControllerFactory::class,
            OutgoingDoc::class => ControllerFactory::class,
            IncomingDoc::class => ControllerFactory::class,
            TrainingFeedback::class => ControllerFactory::class,
            LeaveEncashment::class => ControllerFactory::class,
    ...
    'view_manager' => [
        'template_map' => [
            ...
            // 'selfservice/vacancies' => __DIR__ . '/../view/self-service/vacancy/internal/index.phtml',
        ],
        'template_path_stack' => [
            __DIR__ . '/../view',
        ]
