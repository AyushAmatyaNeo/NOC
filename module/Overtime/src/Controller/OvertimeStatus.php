...
class OvertimeStatus extends HrisController {
    ...
    public function viewAction() {
        ...
        if (!$request->isPost()) {
            ...
            //$overtimeModel->overtimeDate = Helper::getExpressionDate($overtimeModel->overtimeDate);
            //$overtimeModel->requestedDate = Helper::getExpressionDate($overtimeModel->requestedDate);
