...
use Setup\Controller\LocationNocController;
use Setup\Controller\CompanyController;
use Setup\Controller\OsCompanyController;
...
use Setup\Controller\FileSetupController;
...
use Setup\Controller\TrainingExpenseController;
use Setup\Controller\TrainingAccountMapController;
...
return [
    'router' => [
        'routes' => [
            ...
            'oscompany' => [
                'type' => Segment::class,
                'options' => [
                    'route' => '/setup/oscompany[/:action[/:id]]',
                    'constraints' => [
                        'action' => '[a-zA-Z][a-zA-Z0-9_-]*',
                        'id' => '[0-9]+',
                    ],
                    'defaults' => [
                        'controller' => OsCompanyController::class,
                        'action' => 'index',
                    ],
                ],
            ],
            ...
            'locationNoc' => [
                'type' => segment::class,
                'options' => [
                    'route' => '/setup/locationNoc[/:action[/:id]]',
                    'constraints' => [
                        'action' => '[a-zA-Z][a-zA-Z0-9_-]*',
                        'id' => '[0-9]+',
                    ],
                    'defaults' => [
                        'controller' => LocationNocController::class,
                        'action' => 'index',
                    ]
                ],
            ],
            ...
            'trainingExpenseSetup' => [
                'type' => segment::class,
                'options' => [
                    'route' => '/setup/trainingExpenseSetup[/:action[/:id]]',
                    'constants' => [
                        'action' => '[a-zA-Z][a-zA-Z0-9_-]*',
                        'id' => '[0-9]+',
                    ],
                    'defaults' => [
                        'controller' => TrainingExpenseController::class,
                        'action' => 'index',
                    ]
                ],
            ],
            ...
            'trainingAccountMap' => [
                'type' => segment::class,
                'options' => [
                    'route' => '/setup/trainingAccountMap[/:action[/:id]]',
                    'constants' => [
                        'action' => '[a-zA-Z][a-zA-Z0-9_-]*',
                        'id' => '[0-9]+',
                    ],
                    'defaults' => [
                        'controller' => TrainingAccountMapController::class,
                        'action' => 'index',
                    ]
                ],
            ],
            ...
            'insurance' => [
                'type' => Segment::class,
                'options' => [
                    'route' => '/setup/insurance[/:action[/:id]]',
                    'defaults' => [
            ...
            'fileSetup' => [
                'type' => Segment::class,
                'options' => [
                    'route' => '/setup/fileSetup[/:action[/:id]]',
                    'defaults' => [
                        'controller' => FileSetupController::class,
                        'action' => 'index'
                    ]
                ]
            ],
    ...
    'controllers' => [
        'factories' => [
            ...
            OsCompanyController::class => ControllerFactory::class,
            BranchController::class => ControllerFactory::class,
            LocationNocController::class => ControllerFactory::class,
