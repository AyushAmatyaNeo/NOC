...
class HrEmployeesFormTabThree extends Model {
     ...
     * @Annotation\Type("Zend\Form\Element\Text")
     * @Annotation\Filter({"name":"StringTrim","name":"StripTags"})
     * @Annotation\Options({"label":"SSF Number"})
     ...
     * @Annotation\Type("Zend\Form\Element\Text")
     * @Annotation\Filter({"name":"StringTrim","name":"StripTags"})
     * @Annotation\Options({"label":"Name of last Regiment or Corps"})
     * @Annotation\Attributes({ "id":"lastRegimentCorps", "class":"form-control" })
     */
     ...
     * @Annotation\Type("Zend\Form\Element\Text")
     * @Annotation\Filter({"name":"StringTrim","name":"StripTags"})
     * @Annotation\Options({"label":"Last official army/police number"})
     * @Annotation\Attributes({ "id":"lastArmyPoliceNo", "class":"form-control" })
     */
     ...
     * @Annotation\Type("Zend\Form\Element\Text")
     * @Annotation\Filter({"name":"StringTrim","name":"StripTags"})
     * @Annotation\Options({"label":"Last official rank"})
     * @Annotation\Attributes({ "id":"lastOfficialRank", "class":"form-control" })
     */
     ...
     * @Annotation\Required(false)
     * @Annotation\Filter({"name":"StringTrim","name":"StripTags"})
     * @Annotation\Options({"label":"Date of Enlistment"})
     * @Annotation\Attributes({ "id":"enlistmentDate", "class":"form-control" })
     */
     ...
     * @Annotation\Required(false)
     * @Annotation\Filter({"name":"StringTrim","name":"StripTags"})
     * @Annotation\Options({"label":"Date of Discharge"})
     * @Annotation\Attributes({ "id":"dischargeDate", "class":"form-control" })
     */
     ...
     * @Annotation\Type("Zend\Form\Element\Text")
     * @Annotation\Filter({"name":"StringTrim","name":"StripTags"})
     * @Annotation\Options({"label":"Reason for Discharge"})
     * @Annotation\Attributes({ "id":"dischargeReason", "class":"form-control" })
     */
    ...
    public $mappings = [
        ...
        'bankId' => 'BANK_ID',
        'lastRegimentCorps' => 'LAST_REGIMENT_CORPS',
        'lastArmyPoliceNo' => 'LAST_ARMY_POLICE_NO',
        'lastOfficialRank' => 'LAST_OFFICIAL_RANK',
