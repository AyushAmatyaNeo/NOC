...
class JobHistoryForm {
     ...
     * @Annotation\Attributes({"id":"form-roles","class":"form-roles form-control form-roles-jh","style":"    height: 50px; font-size:12px"})
     */
    public $roles;
     ...
     * @Annotation\Required(false)
     * @Annotation\Filter({"name":"StripTags","name":"StringTrim"})
     * @Annotation\Options({"disable_inarray_validator":"true","label":"To Functonal Level"})
     * @Annotation\Attributes({ "id":"toFunctionalLevelId","class":"form-control"})
     */
     ...
     * @Annotation\Filter({"name":"StripTags","name":"StringTrim"})
     * @Annotation\Options({"disable_inarray_validator":"true","label":"To Location Name"})
     * @Annotation\Attributes({ "id":"toLocationId","class":"form-control"})
     */
    public $toLocationId;
     ...
     * @Annotation\Required({"required":"false"})
     * @Annotation\Filter({"name":"StripTags","name":"StringTrim"})
     * @Annotation\Options({"disable_inarray_validator":"true","label":"To Acting Position Name"})
     * @Annotation\Attributes({ "id":"toActingPositionId","class":"form-control"})
     */
     ...
     * @Annotation\Required({"required":"false"})
     * @Annotation\Filter({"name":"StripTags","name":"StringTrim"})
     * @Annotation\Options({"disable_inarray_validator":"true","label":"To Acting Functional Level"})
     * @Annotation\Attributes({ "id":"toActingFunctionalLevelId","class":"form-control"})
     */
     ...
     * @Annotation\Required({"required":"false"})
     * @Annotation\Filter({"name":"StripTags","name":"StringTrim"})
     * @Annotation\Options({"disable_inarray_validator":"true","label":"To Service Group Name"})
     * @Annotation\Attributes({ "id":"toServiceGroupId","class":"form-control"})
     */
     ...
     * @Annotation\Required({"required":"false"})
     * @Annotation\Filter({"name":"StripTags","name":"StringTrim"})
     * @Annotation\Options({"disable_inarray_validator":"true","label":"To Service Sub Group Name"})
     * @Annotation\Attributes({ "id":"toServiceSubGroupId","class":"form-control"})
     */
