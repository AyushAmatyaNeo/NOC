...
class HrEmployeesFormTabFour extends Model {
     ...
     * @Annotation\Validator({"name":"StringLength", "options":{"max":"12"}})
     ...
     * @Annotation\Attributes({ "id":"servicesId","class":"form-control"})
     */
    public $servicesId;
     ...
     * @Annotation\Required(false)
     * @Annotation\Filter({"name":"StringTrim","name":"StripTags"})
     * @Annotation\Options({"disable_inarray_validator":"true","label":"Service Sub Group"})
     * @Annotation\Attributes({ "id":"serviceSubgroupId","class":"form-control"})
     */
     ...
     * @Annotation\Required(false)
     * @Annotation\Filter({"name":"StringTrim","name":"StripTags"})
     * @Annotation\Options({"disable_inarray_validator":"true","label":"Acting Position Name"})
     * @Annotation\Attributes({ "id":"actingPositionId","class":"form-control"})
     */
    public $actingPositionId;
     ...
     * @Annotation\Required(False)
     * @Annotation\Filter({"name":"StringTrim","name":"StripTags"})
     * @Annotation\Options({"disable_inarray_validator":"true","label":"Outsource Company"})
     * @Annotation\Attributes({ "id":"osCompanyId","class":"form-control"})
     */
    public $osCompanyId;
     ...
     * @Annotation\Validator({"name":"StringLength", "options":{"max":"12"}})
     * @Annotation\Attributes({ "id":"allowance", "class":"form-control","step":"0.01","min":"0"})
     */
    public $allowance ;
     ...
     * @Annotation\Required(false)
     * @Annotation\Filter({"name":"StringTrim","name":"StripTags"})
     * @Annotation\Options({"disable_inarray_validator":"true","label":"Acting Functional Level"})
     * @Annotation\Attributes({ "id":"actingFunctionalLevelId","class":"form-control"})
     */
    public $actingFunctionalLevelId;

    /**
     * @Annotation\Type("Zend\Form\Element\Radio")
     * @Annotation\Required(false)
     * @Annotation\Filter({"name":"StringTrim","name":"StripTags"})
     * @Annotation\Options({"label":"Include in Payroll","value_options":{"Y":"Yes","N":"No"}})
     * @Annotation\Attributes({"id":"includeInPayroll","value":"Y"})
     */
    public $includeInPayroll;

    /**
     * @Annotation\Type("Zend\Form\Element\Select")
     * @Annotation\Required(true)
     * @Annotation\Filter({"name":"StringTrim","name":"StripTags"})
     * @Annotation\Options({"disable_inarray_validator":"true","label":"Travel Allowance Class"})
     * @Annotation\Attributes({ "id":"travelAllowanceClass","class":"form-control"})
     */
    public $travelAllowanceClass;
    ...
    public $mappings = [
        ...
        'osCompanyId'=>'OS_COMPANY_ID',
        'servicesId' =>'SERVICE_ID',
        'serviceSubgroupId'=>'SERVICE_SUBGROUP_ID',
        ...
        'actingFunctionalLevelId' => 'ACTING_FUNCTIONAL_LEVEL_ID',
        'actingPositionId' => 'ACTING_POSITION_ID',
        'includeInPayroll' => 'INCLUDE_IN_PAYROLL',
        'travelAllowanceClass' => 'TRAVEL_ALLOWANCE_CLASS'
    ];
