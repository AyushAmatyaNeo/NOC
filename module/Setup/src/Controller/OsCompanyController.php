...
class OsCompanyController extends HrisController {

    private $synergyRepo;

    public function __construct(AdapterInterface $adapter, StorageInterface $storage) {
        parent::__construct($adapter, $storage);
        $this->initializeRepository(OsCompanyRepository::class);
        $this->initializeForm(OsCompanyForm::class);
    ...
    public function addAction() {
        ...
        if ($request->isPost()) {
            ...
            if ($this->form->isValid()) {
                ...
                $company->companyId = ((int) Helper::getMaxId($this->adapter, OsCompany::TABLE_NAME, OsCompany::COMPANY_ID)) + 1;
                if($postedData['logo']==''){
                    $company->logo = null;
                }else{
                ...
                return $this->redirect()->toRoute("oscompany");
            } else {
        ...
        try {
            ...
            if (sizeof($files) > 0) {
                ...
                if ($success) {
                    ...
                    $file->fileId = ((int) Helper::getMaxId($this->adapter, 'HRIS_EMPLOYEE_FILE', 'FILE_CODE')) + 1;
