...
class HrEmployees extends Model {
    ...
    public $disabledFlag;
    public $taxBase;
    public $lastRegimentCorps;
    public $lastArmyPoliceNo;
    public $lastOfficialRank;
    public $enlistmentDate;
    ...
    const ETHNICITY_ID = 'ETHNICITY_ID';
    ...
    const ACTING_FUNCTIONAL_LEVEL_ID = "ACTING_FUNCTIONAL_LEVEL_ID";
    const ACTING_POSITION_ID = "ACTING_POSITION_ID";
    ...
    const LAST_REGIMENT_CORPS = "LAST_REGIMENT_CORPS";
    const LAST_ARMY_POLICE_NO = "LAST_ARMY_POLICE_NO";
    const LAST_OFFICIAL_RANK = "LAST_OFFICIAL_RANK";
    const ENLISTMENT_DATE = "ENLISTMENT_DATE";
    const DISCHARGE_DATE = "DISCHARGE_DATE";
    const DISCHARGE_REASON = "DISCHARGE_REASON";
    const CHECKED = "CHECKED";
    const CHECKED_BY = "CHECKED_BY";
    const CHECKED_DT = "CHECKED_DT";
    const VERIFIED = "VERIFIED";
    const VERIFIED_BY = "VERIFIED_BY";
    const VERIFIED_DT = "VERIFIED_DT";
    const INCLUDE_IN_PAYROLL = "INCLUDE_IN_PAYROLL";
    const TRAVEL_ALLOWANCE_CLASS = "TRAVEL_ALLOWANCE_CLASS";
    const OS_COMPANY_ID ="OS_COMPANY_ID";
    ...
    public $mappings = [
        ...
        'actingFunctionalLevelId' => self::ACTING_FUNCTIONAL_LEVEL_ID,
        'actingPositionId' => self::ACTING_POSITION_ID,
        ...
        'lastRegimentCorps' => self::LAST_REGIMENT_CORPS,
        'lastArmyPoliceNo' => self::LAST_ARMY_POLICE_NO,
        'lastOfficialRank' => self::LAST_OFFICIAL_RANK,
        ...
        'verifiedDt' => self::VERIFIED_DT,
        'includeInPayroll' => self::INCLUDE_IN_PAYROLL,
        'travelAllowanceClass' => self::TRAVEL_ALLOWANCE_CLASS,
        'osCompanyId' => self::OS_COMPANY_ID,
