...
class LeaveMaster extends Model {
    ...
    const SERVICE_PERIOD_REQUIRED = "SERVICE_PERIOD_REQUIRED";
    const DAYS_MATURED = "DAYS_MATURED";
    ...
    public $mappings = [
        ...
        'servicePeriodRequired' => self::SERVICE_PERIOD_REQUIRED,
        'daysMatured' => self::DAYS_MATURED,
