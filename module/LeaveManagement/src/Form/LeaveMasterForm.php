...
class LeaveMasterForm {
     ...
     * @Annotation\Type("Zend\Form\Element\Number")
     * @Annotation\Filter({"name":"StringTrim","name":"StripTags"})
     * @Annotation\Options({"label":"Service Period Required (in years)"})
     * @Annotation\Required(false)
     * @Annotation\Attributes({ "id":"servicePeriodRequired", "class":"form-control","step":"1"})
     */
    public $servicePeriodRequired;

    /**
     * @Annotation\Type("Zend\Form\Element\Number")
     * @Annotation\Filter({"name":"StringTrim","name":"StripTags"})
     * @Annotation\Options({"label":"Days Matured"})
     * @Annotation\Required(false)
     * @Annotation\Attributes({ "id":"daysMatured", "class":"form-control","step":"1"})
     */
    public $daysMatured;
     ...
     * @Annotation\Type("Zend\Form\Element\Number")
     * @Annotation\Filter({"name":"StringTrim","name":"StripTags"})
     * @Annotation\Options({"label":"Minimum Days for Encashment"})
     * @Annotation\Required(false)
     * @Annotation\Attributes({ "id":"minDaysForEncash", "class":"form-control","step":"1"})
     */
     ...
     * @Annotation\Type("Zend\Form\Element\Radio")
     * @Annotation\Filter({"name":"StringTrim","name":"StripTags"})
     * @Annotation\Options({"value_options":{"Y":"Yes","N":"No"},"label":"Impact Grades"})
     * @Annotation\Required(false)
     * @Annotation\Attributes({ "id":"impactGrade","value":"N"})
     */
    public $impactGrade;
     ...
     * @Annotation\Type("Zend\Form\Element\Radio")
     * @Annotation\Filter({"name":"StringTrim","name":"StripTags"})
     * @Annotation\Options({"value_options":{"Y":"Yes","N":"No"},"label":"Count as Service Period"})
     * @Annotation\Required(false)
     * @Annotation\Attributes({ "id":"countAsServicePeriod","value":"Y"})
     */
