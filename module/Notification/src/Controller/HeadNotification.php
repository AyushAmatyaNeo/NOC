...
//                ${"fn" . NotificationEvents::TRAVEL_CANCELLED}($model, $adapter, $url);
    ...
    public static function sendMassMailCircular(AdapterInterface $adapter, $postData, $subject, $description) {
        $bcc = true;
        ...
        if (!isset($postData['company']) &&
            ...
            $notiRepo = new NotificationRepo($adapter);
            $sendList = $notiRepo->fetchAllEmployeeEmailCircular($postData);
        }
