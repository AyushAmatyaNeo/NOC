...
class NotificationRepo extends HrisRepository implements RepositoryInterface {
    ...
    public function fetchAllEmployeeEmailCircular($postData) {
        $whereCondition = EntityHelper::getSearchConditonBounded($postData['company'], $postData['branch'], $postData['department'], $postData['position'], $postData['designation'], $postData['serviceType'], $postData['serviceEventType'], $postData['employeeType'], $postData['employee'], $postData['gender'], $locationID = null);
