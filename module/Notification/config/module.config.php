...
return [
    'router' => [
        'routes' => [
            ...
            'auto-notification' => [
                'type' => Segment::class,
                'options' => [
                    'route' => '/autoNotification[/:action[/:id]]',
                    'constraints' => [
                        'action' => '[a-zA-Z][a-zA-Z0-9_-]*',
                        'id' => '[0-9]+',
                    ],
                    'defaults' => [
                        'controller' => Controller\AutoNotification::class,
                        'action' => 'index'
                    ],
                ],
            ],
    ...
    'controllers' => [
        'factories' => [
            ...
            Controller\AutoNotification::class => \Application\Controller\ControllerFactory::class
        ],
    ],
    'navigation' => [
        'notification' => [
