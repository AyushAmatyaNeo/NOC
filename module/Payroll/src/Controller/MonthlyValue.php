...
class MonthlyValue extends HrisController {
    ...
    public function detailAction() {
        $monthlyValues = EntityHelper::getTableList($this->adapter, MonthlyValueModel::TABLE_NAME, [MonthlyValueModel::MTH_ID, MonthlyValueModel::MTH_EDESC],[MonthlyValueModel::STATUS => 'E', MonthlyValueModel::ASSIGN_TYPE => 'E']);
    ...
    public function positionWiseAction() {
        ...
        $monthlyValues = EntityHelper::getTableList($this->adapter, MonthlyValueModel::TABLE_NAME, [MonthlyValueModel::MTH_ID, MonthlyValueModel::MTH_EDESC],[MonthlyValueModel::STATUS => 'E', MonthlyValueModel::ASSIGN_TYPE => 'P']);
