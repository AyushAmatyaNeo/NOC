        ...
        if ($payId == null) {
            ...
            $sql = "
                SELECT P.PAY_ID,
                  ...
                  INITCAP(P.PAY_LDESC) AS PAY_LDESC
                FROM HRIS_PAY_SETUP P,
                  (SELECT PRIORITY_INDEX FROM HRIS_PAY_SETUP WHERE PAY_ID=?
                  ) PS
    ...
    public function fetchAllTypeWise($sheetNo): Traversable {
      ...
      $boundedParameter = [];
        ...
        $query = "SELECT PS.PAY_ID,
                ...
                left join (select SALARY_TYPE_ID from Hris_Salary_Sheet where sheet_no=?) SS on (1=1)
