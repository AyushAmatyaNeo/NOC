...
use ManagerService\Controller\OvertimeClaimApproveController;
...
use ManagerService\Controller\TransferSettlementApproveController;
...
return [
    'router' => [
        'routes' => [
            ...
            'overtimeclaimapprove' => [
                'type' => Segment::class,
                'options' => [
                    'route' => '/managerservice/overtimeclaimapprove[/:action[/:id][/:role]]',
                    'defaults' => [
                        'controller' => OvertimeClaimApproveController::class,
                        'action' => 'index'
                    ]
                ]
            ],
            ...
            'transferSettlementApprove' => [
                'type' => Segment::class,
                'options' => [
                    'route' => '/managerservice/travelSettlementApprove[/:action[/:id][/:role]]',
                    'defaults' => [
                        'controller' => TransferSettlementApproveController::class,
                        'action' => 'index'
                    ]
                ]
            ],
    ...
    'navigation' => [
        ...
        'transferSettlementApprove' => [
            [
                'label' => 'Travel Request',
                'route' => 'transferSettlementApprove',
            ],
            [
                'label' => 'Travel Request',
                'route' => 'transferSettlementApprove',
    ...
    'controllers' => [
        'factories' => [
            ...
            OvertimeClaimApproveController::class => ControllerFactory::class,
            ...
            TransferSettlementApproveController::class =>ControllerFactory::class,
