...
return [
    'router' => [
        'routes' => [
            ...
            'attendanceDevice' => [
                'type' => Segment::class,
                'options' => [
                    'route' => '/attendance/attendanceDevice[/:action[/:id]]',
                    'constants' => [
                        'action' => '[a-zA-Z][a-zA-Z0-9_-]*',
                        'id' => '[0-9]+',
                    ],
                    'defaults' => [
                        'controller' => Controller\AttendanceDeviceController::class,
                        'action' => 'index',
                    ]
                ],
            ],
            ...
            'attendancereport' => [
                ...
                'options' => [
                    ...
                    'defaults' => [
                        'controller' => Controller\AttendanceReport::class,
                        'action' => 'index',
                    ]
                ],
            ],
            ...
            'attendancenew' => [
                'type' => Segment::class,
                'options' => [
                    'route' => '/attendance/attendanceNew[/:action[/:id]]',
                    'constants' => [
                        'action' => '[a-zA-Z][a-zA-Z0-9_-]*',
                        'id' => '[0-9]+',
                    ],
                    'defaults' => [
                        'controller' => Controller\AttendanceNew::class,
                        'action' => 'index',
                    ]
                ],
            ],
            'attendancePullApi' => [
                'type' => Segment::class,
                'options' => [
                    'route' => '/attendance/attendancePullApi[/:action[/:id]]',
                    'constants' => [
                        'action' => '[a-zA-Z][a-zA-Z0-9_-]*',
                        'id' => '[0-9]+',
                    ],
                    'defaults' => [
                        'controller' => Controller\AttendancePullApi::class,
                        'action' => 'index',
                    ]
                ],
            ],
    ...
    'navigation' => [
        ...
        'attendancePullApi' => [
            [
                'label' => 'Attendance pull API',
                'route' => 'attendancePullApi',
            ],
            [
                'label' => 'Attendance pull API',
                'route' => 'attendancePullApi',
    ...
    'controllers' => [
        'factories' => [
            ...
            Controller\AttendanceReport::class => ControllerFactory::class,
            ...
            Controller\AttendanceNew::class => ControllerFactory::class,
            Controller\SpecialAttendanceController::class => ControllerFactory::class,
            Controller\AttendancePullApi::class => ControllerFactory::class,
            Controller\AttendanceDeviceController::class => ControllerFactory::class,
        ],
    ],
    'view_manager' => [
        'template_path_stack' => [
