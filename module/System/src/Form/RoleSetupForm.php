...
class RoleSetupForm {
     ...
     * @Annotation\Filter({"name":"StringTrim","name":"StripTags"})
     * @Annotation\Options({"disable_inarray_validator":"true"})
     * @Annotation\Attributes({ "id":"selectOptionsL","class":"form-control","multiple":"True"})
     */
    public $selectOptionsL;
        /**
     * @Annotation\Type("Zend\Form\Element\Select")
     * @Annotation\Required(false)
     * @Annotation\Filter({"name":"StringTrim","name":"StripTags"})
     ...
     * @Annotation\Type("Zend\Form\Element\Radio")
     * @Annotation\Filter({"name":"StringTrim","name":"StripTags"})
     * @Annotation\Options({"value_options":{"Y":"Yes","N":"No"},"label":"Checker"})
     * @Annotation\Required(false)
     * @Annotation\Attributes({ "id":"checker"})
     */
    public $checker;
     ...
     * @Annotation\Type("Zend\Form\Element\Radio")
     * @Annotation\Filter({"name":"StringTrim","name":"StripTags"})
     * @Annotation\Options({"value_options":{"Y":"Yes","N":"No"},"label":"Maker"})
     * @Annotation\Required(false)
     * @Annotation\Attributes({ "id":"maker"})
     */
    public $maker;
