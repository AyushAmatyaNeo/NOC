...
//                console.log(acl['CONTROL']);
         ...
         */
        var changeSearchOption = function (companyId, branchId, departmentId, designationId, positionId, serviceTypeId, serviceEventTypeId, employeeId, genderId, employeeTypeId, functionalTypeId) {
...
//                document.searchManager.setfunctionalType(document.searchValues['functionalType']);
        ...
        if (typeof document.searchValues !== 'undefined') {
            changeSearchOption("companyId", "branchId", "departmentId", "designationId", "positionId", "serviceTypeId", "serviceEventTypeId", "employeeId", "genderId", "employeeTypeId","functionalTypeId");
        } else {
