...
(function ($, app) {
    ...
    $(document).ready(function () {
        ...
        var $selectOptionsL = $("#selectOptionsL");
        var $control = $("#control");
        ...
        app.populateSelect($selectOptionsL, document.searchValues['location'], 'LOCATION_ID', 'LOCATION_EDESC', '---', '');
        ...
        let selectedOptionsC = [], selectedOptionsDS = [], selectedOptionsDP = [], selectedOptionsP = [], selectedOptionsB = [], selectedOptionsL = [];
        ...
        if(document.controls != null){
            ...
            if(document.controls.includes('L')){
                selectedOptionsL = document.selectedControlValues.filter(i => i.CONTROL == 'L').map(j => j.VAL);
                $selectOptionsL.val(selectedOptionsL);
            }
        }
        ...
        function hideShowSelect(show = null){
            $(".selectOptions, .selectOptionsP, .selectOptionsDS, .selectOptionsDP, .selectOptionsB, .selectOptionsC, .selectOptionsL").hide();
