(function ($,app) {
    $(document).ready(function () {
        ...
        var deleteAction = document.acl.ALLOW_DELETE == 'Y' ? '<a class="confirmation btn-delete" title="Delete" href="' + document.deleteLink + '/#:DISPATCH_ID#" style="height:17px;"><i class="fa fa-trash-o"></i></a>' : '';
        ...
        app.initializeKendoGrid($table, [
            ...
            {field: "DISPATCH_ID", title: "Action", width: 80, template: action},
