(function ($, app) {
    ...
    $(document).ready(function () {
        ...
        let viewLink = `<a class="btn-edit" title="View" href="${document.viewLink}/#:EMPLOYEE_ID#" style="height:17px;">
                            <i class="fa fa-search-plus"></i>
                        </a> `;

        let editLink = "";
        if (document.acl.ALLOW_UPDATE === "Y") {
            editLink = `#if(VERIFIED != 'Y'){#
                            <a class="btn-edit" title="Edit" href="${document.editLink}/#:EMPLOYEE_ID#" style="height:17px;">
        ...
        let deleteLink = "";
        if (document.acl.ALLOW_DELETE === "Y") {
            deleteLink = `#if(VERIFIED != 'Y'){#
                            <a class="confirmation btn-delete " title="Delete" href="${document.deleteLink}/#:EMPLOYEE_ID#" style="height:17px;">
        ...
        let checkLink = "";
        if (document.acl.CHECKER === "Y") {
            checkLink = `#if(CHECKED=='Y'){#
                            <a class="confirmation btn-edit"  title="Uncheck?" href="${document.checkVerifyLink}/#:EMPLOYEE_ID#/C0" style="height:17px;">
                                <i class="fa fa-check-circle-o" aria-hidden="true" style="height:17px;"></i>
                            </a>
                        #}else{#
                            <a class="confirmation btn-edit" title="Check?" href="${document.checkVerifyLink}/#:EMPLOYEE_ID#/C1" style="height:17px;" >
                                <i class="fa fa-check-circle-o"  aria-hidden="true" style="color: red;"></i>
                            </a>
                        #}#`;
        }

        let verifyLink = "";
        if (document.acl.MAKER === "Y") {
            verifyLink = `#if(VERIFIED=='Y'){#
                            <a class="confirmation btn-edit" title="Unverify?" href="${document.checkVerifyLink}/#:EMPLOYEE_ID#/V0" style="height:17px;" >
                                <i class="fa fa-lock"  aria-hidden="true"></i>
                            </a>
                        #}else{#
                            <a class="confirmation btn-edit" title="Verify?" href="${document.checkVerifyLink}/#:EMPLOYEE_ID#/V1" style="height:17px;" >
                                <i class="fa fa-unlock"  aria-hidden="true"></i>
                            </a>
                        #}#`;
        }

        const actiontemplateConfig = viewLink + editLink + deleteLink + checkLink + verifyLink;
        ...
        app.initializeKendoGrid($employeeTable, [
            ...
            {field: "EMPLOYEE_ID", title: "Action", width: 180, locked: true, template: actiontemplateConfig}
