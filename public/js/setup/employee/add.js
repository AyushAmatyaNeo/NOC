(function ($, app) {
    ...
    $(document).ready(function () {
        ...
        var $id_account_no = $("#idAccountId");
        var $id_lbrf = $("idLbrf");
        var $userBankAvailability = $("#userBankAvailability");
        var $userLbrfAvailability = $("#userLbrfAvailability");

        

        var userBankAvailable;
        var userLbrfAvailable;

        function checkIsBankAccountAvailable() {
            app.serverRequest(document.checkBankAccount, {
                id_account_no: $id_account_no.val(),
                employee_id: document.employeeId
                
            }).then(function (response) {
                console.log(response);
                if (response.success == true && response.data == 'YES') {
                    $userBankAvailability.html('Available');
                    $userBankAvailability.css('color', 'green');
                    userBankAvailable = true;
                    
                    document.getElementById("spanTag").style.display = "block";

                } else {
                    $userBankAvailability.html('Not Available');
                    $userBankAvailability.css('color', 'red');
                    userBankAvailable = false;
        ...
        $id_account_no.on("blur input", function () {
            checkIsBankAccountAvailable();
        });
        /*
         * 
         */
        ...
        function checkIsLbrfAvailable() {
            app.serverRequest(document.checkLbrf, {
                id_lbrf: $id_lbrf.val(),
                employee_id: document.employeeId
                ...
                console.log(response);
                if (response.success == true && response.data == 'YES') {
                    $userLbrfAvailability.html('Available');
                    $userLbrfAvailability.css('color', 'green');
                    userLbrfAvailable = true;
                    
                    document.getElementById("spanTag").style.display = "block";

                } else {
                    $userLbrfAvailability.html('Not Available');
                    $userLbrfAvailability.css('color', 'red');
                    userLbrfAvailable = false;
        ...
        $id_lbrf.on("blur input", function () {
            checkIsLbrfAvailable();
        });
