(function ($, app) {
    ...
    $(document).ready(function () {
        ...
        var dt = new Date($('#departureDate').val());
        ...
        // $('.depDate:last').datepicker('setEndDate', app.getSystemDate(response.data.serverDate));
            ...
            // $('.depDate:last').datepicker('setEndDate', app.getSystemDate(extendedEndDate));
            ...
            // $('.depDateInternational:last').datepicker('setStartDate', app.getSystemDate(extendedStartDate));
            // $('.depDateInternational:last').datepicker('setEndDate', app.getSystemDate(extendedEndDate));
        ...
        $('.deatilAddBtn').on('click', function () {
            ...
            <tr>
                ...
                <td>
                <div style="width:90px">
                    <input style="width:100%" type="text" name="familyName[]"  class="familyName">       
                </div>
            </td>
                <td>
        ...
        var checkForErrors = function (datesArr, isFamilyArr) {
            app.pullDataById(document.validateSettlementExpense, {dates: datesArr, isFamily: isFamilyArr}).then(function (response) {
