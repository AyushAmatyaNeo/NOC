    ...
    $(document).ready(function () {
        ...
        var action = `
            <div class="clearfix">
                ...
                #if(STATUS =='AP'){#
                    <a  class="btn btn-icon-only yellow" href="${document.jvAddExpenseLink}/#:TRAVEL_ID#" style="height:17px;" title="ADD JV NUMBER AND CHEQUE NUMBER">
                    <i class="fa fa-plus-circle"></i>
                </a>
                #}#
                #}#
        ...
        app.initializeKendoGrid($table, [
            ...
            {field: "TRANSPORT_TYPE_LIST", title: "Transport"},
