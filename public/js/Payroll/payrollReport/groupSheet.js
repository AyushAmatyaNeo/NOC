(function ($, app) {
    ...
    $(document).ready(function () {
        ...
        var initKendoGrid = function (defaultColumns, otVariables, extraVariable, data) {
            ...
            var columns = [
                {field: "SERIAL", title: "S.N.", width: 50, locked: true},
                ...
                {field: "MARITAL_STATUS", title: "Marrital Status", width: 100, locked: true},
                {field: "DESIGNATION_TITLE", title: "Designation", width: 100, locked: true},
                {field: "FUNCTIONAL_LEVEL_EDESC", title: "Functional Level", width: 120, locked: true},
                {field: "LOCATION_EDESC", title: "Location", width: 120, locked: true},
                {field: "BANK_NAME", title: "Bank Name", width: 120, locked: false},
                {field: "ID_ACCOUNT_NO", title: "Bank A/C", width: 120, locked: false},
                {field: "ID_PAN_NO", title: "Pan Number", width: 120, locked: false},
                {field: "ID_PROVIDENT_FUND_NO", title: "Provident Fund No.", width: 120, locked: false},
                {field: "ID_RETIREMENT_NO", title: "CIT No.", width: 120, locked: false}
            ];
