(function ($, app) {
    ...
    $(document).ready(function () {
        ...
        // var getEmployeeTypeListLink = data['links']['getEmployeeTypeListLink'];
        var companyList = [];
        var groupList = [];
...
//
        ...
        app.populateSelect($employeeTypeId, employeeTypeList, 'CODE', 'NAME', 'Select Employee Type',null, 1, true);
...
//            groupChangeFn();
        ...
        $employeeTypeId.on("select2:select select2:unselect", function (event) {
            monthChangeAction();
//            groupChangeFn();
        ...
        var groupChangeFn=function(){
            ...
            let selectedEmployeeType = $employeeTypeId.val();
...
//                    console.log(value);
            ...
            if(selectedEmployeeType==null){
                let allEmployeeType=['R','C'];

                selectedEmployeeType=allEmployeeType;
            }
...
//                    console.log(response);
        ...
        var employeePFColumn = {
            field: "ID_PROVIDENT_FUND_NO",
            title: "Profident Fund No",
            width: 100
        };
        var employeePANColumn = {
            field: "ID_PAN_NO",
            title: "PAN No",
            width: 100
        };
        ...
        // };
        template: `<a class="btn-edit hris-regenerate-salarysheet" title="Regenerate" sheet-no="#: SHEET_NO #" employee-id="#: EMPLOYEE_ID #" style="height:17px;"> <i class="fa fa-recycle"></i></a>
                        <a class="confirmation btn-delete hris-delete-salary" title="Delete" sheet-no="#: SHEET_NO #" employee-id="#: EMPLOYEE_ID #" style="height:17px;"> <i class="fa fa-trash-o"></i></a>`
    };
        if (data.ruleList.length > 0) {
            ...
            employeePFColumn.locked = true;
            employeePANColumn.locked = true;
