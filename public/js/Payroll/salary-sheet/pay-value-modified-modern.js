(function ($, app) {
    ...
    $(document).ready(function () {
        ...
        var employeeTypes = [{'EMPLOYEE_TYPE_ID':'R', 'EMPLOYEE_TYPE_NAME':'Regular'},
        {'EMPLOYEE_TYPE_ID':'C', 'EMPLOYEE_TYPE_NAME':'Contract'}];
        app.populateSelect($employeeTypeId, employeeTypes, "EMPLOYEE_TYPE_ID", "EMPLOYEE_TYPE_NAME");
        ...
        $searchEmployeesBtn.on('click', function () {
            ...
            if ($employeeTypeId.val() == -1) {
                app.showMessage("No Employee Type Selected.", 'error');
                $employeeTypeId.focus();
                return;
            }
            $table.empty();
