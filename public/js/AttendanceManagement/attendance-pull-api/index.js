(function ($, app) {
    ...
    $('#submitBtn').on('click', function(){
        var fromDt = $('#startDate1').val();
        var endDt = $('#endDate1').val();
        var fromDevice = $('#fromDevice').val();
        app.serverRequest('', {fromDt:fromDt,endDt:endDt,fromDevice:fromDevice}).then(function (response) {
            if (response.success) {
                app.showMessage(response.messg, 'success');
            } else {
