(function ($) {
    ...
    $(document).ready(function () {
        ...
        var viewAction = '<span><a class="btn-edit" href="' + document.viewLink + '/#:EMPLOYEE_ID #/#:TRAINING_ID #" style="height:17px;" title="View Details">'
                + '<i class="fa fa-search-plus"></i>'
                + '</a>'
                + '</span>';
        var acceptAction = `#if(ACCEPT_FLAG ==null){#<a class="btn-edit" title="Accept" href="` + document.acceptLink + `/#:EMPLOYEE_ID #/#:TRAINING_ID #" style="height:17px;"> <i class="fa fa-check"></i></a>#}#`;
        var declineAction = `#if(ACCEPT_FLAG ==null){#<a class="btn-edit" title="Decline" href="` + document.declineLink + `/#:EMPLOYEE_ID #/#:TRAINING_ID #" style="height:17px;"> <i class="fa fa-times"></i></a>#}#`;
        
        var action = viewAction+acceptAction+declineAction;
